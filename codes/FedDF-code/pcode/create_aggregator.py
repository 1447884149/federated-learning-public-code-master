...
class Aggregator(object):
    ...
    def aggregate(
        ...
        **kwargs,
        ...
        # apply advanced aggregate_fn.应用高级聚合函数
        self.logger.log(
        ...
        #如果指定了 aggregate_fn_name，则通过 getattr(self, aggregate_fn_name)() 获取对应的聚合函数；否则使用默认的聚合函数 self.aggregate_fn。将得到的聚合函数保存在 _aggregate_fn 变量中。
        _aggregate_fn = (
            self.aggregate_fn
